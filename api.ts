...
export const IamBackofficeApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async iamBackofficeAssignUserToGroup(body: IambackofficeAssignUserToGroupRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['IamBackofficeApi.iamBackofficeAssignUserToGroup']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * 
        ...
        async iamBackofficeGetUser(body: IambackofficeGetUserRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<IambackofficeGetUserResponse>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['IamBackofficeApi.iamBackofficeGetUser']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * 
        ...
        async iamBackofficeSearchGroups(body: IambackofficeSearchGroupsRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<IambackofficeSearchGroupsResponse>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['IamBackofficeApi.iamBackofficeSearchGroups']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * 
...
export const IamBackofficeApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        iamBackofficeAssignUserToGroup(body: IambackofficeAssignUserToGroupRequest, options?: any): AxiosPromise<object> {
         ...
         * @throws {RequiredError}
         */
        iamBackofficeGetUser(body: IambackofficeGetUserRequest, options?: any): AxiosPromise<IambackofficeGetUserResponse> {
         ...
         * @throws {RequiredError}
         */
        iamBackofficeSearchGroups(body: IambackofficeSearchGroupsRequest, options?: any): AxiosPromise<IambackofficeSearchGroupsResponse> {
